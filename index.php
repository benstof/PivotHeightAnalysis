 ...
 <body onload="initialize()" style="background: #00ff00 url('grid.png') repeat;">
  ...
  <div id="main" style="width:100%; float:left;">
     ...
     <div id="disclaimer_box" style="display:none; padding:100px; display:block; z-index:1; position:absolute; top:70px; opacity:.9;  left:200px; width: 700px; height:1000px; background-color:#888888;">
...
from this site and bears no responsibility.</h2><h2>
...
For accurate elevation data a physical survey must be done to verify the elevation differences.</h2>
...
<div id="aggree_btn" style="background-color:#555; text-align:center; border:1px solid #000; margin:auto auto; "> <b style="font-size:20px; color:#fff; margin:auto auto;" >Agree</b></div>
    ...
    <div id="wrapper" style="width:900px; margin: auto;">
      ...
      <div style="width:350px; text-align:center;  border:0px solid #000; padding:5px; margin:0px; float:left; font-family:arial; font-size:18px; " >


        <div style="width:350px; border:1px solid #888; background-color:#eee; padding:5px; margin:5px; float:left;  " >
          <div style="margin:5px;" > 
            Address:
            <input type="radio" name="adt" id="address_rb" checked onchange="updateAdt()" >
            Lat/Lng: 
            <input type="radio" name="adt" id="location_rb" onchange="updateAdt()">
            Current: 
            <input type="radio" name="adt" id="current_rb" onchange="updateAdt()">



            <input style="margin-left: 5px; width:300px; margin-right: 5px;  font-size:14px; 
            ...
            <br/>
            <span style="display:nokne;" >Lat:<input id="lat_address" disabled style=" margin-left: 5px; width:150px; margin-right: 5px;  font-size:14px; 
            padding:5px;"  type="textbox" value="" ></span><br/>
            <span style="display:nokne;" >Lng:<input id="lng_address" disabled style="margin-left: 5px; width:150px; margin-right: 5px;  font-size:14px; 
            padding:5px;"  type="textbox" value="" ></span><br/>
      ...
      <p>
        <b>Thanks for your pivot height analysis submission.</b>
      </p>
      <p>
        <b>Someone will be in touch with you shortly.</b>
      </p>
